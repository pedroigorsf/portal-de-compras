<div class="row">
    ...
    <div class="col-sm-2">
        ...
        <input type="radio" value="1" class="btn-check btn w-100" name="stats" id="success-outlined" autocomplete="off">
        <label class="btn btn-outline-success btn" for="success-outlined">Ativo</label>

        <input type="radio" value="0" class="btn-check btn w-100" name="stats" id="danger-outlined" autocomplete="off">
    ...
    <div class="col-sm-5">
        ...
        <div class="form-outline">
            ...
            <input type="text" name="nome" id="form8Example1" class="form-control"
                value="<?= isset($fornecedor) ? $fornecedor["nome"] : ""; ?>" required
    ...
    <div class="col">
        ...
        <div class="form-outline">
            ...
            <input type="text" name="cep" id="cep" class="form-control" size="10" maxlength="9" data-mask="00.000/000"
                onblur="pesquisacep(this.value);" value="<?= isset($fornecedor) ? $fornecedor["cep"] : ""; ?>"
                required />
...
<div class="row py-2">
    ...
    <div class="col-sm-5">
        ...
        <div class="form-outline">
            ...
            <input type="text" name="endereco" id="rua" class="form-control text-uppercase" placeholder=""
                value="<?= isset($fornecedor) ? $fornecedor["endereco"] : ""; ?>" required
                oninput="this.value = this.value.toUpperCase()" />
    ...
    <div class="col-sm-1">
        <!-- Name input -->
        <div class="form-outline">
            <label class="form-label" for="form8Example3">Número</label>
            <input type="text" name="numero" id="numero" class="form-control text-uppercase" placeholder=""
                value="<?= isset($fornecedor) ? $fornecedor["numero"] : ""; ?>" required
                oninput="this.value = this.value.toUpperCase()" />
    ...
    <div class="col-sm-3">
        ...
        <div class="form-outline">
            ...
            <input type="text" name="bairro" id="bairro" class="form-control text-uppercase" placeholder=""
                value="<?= isset($fornecedor) ? $fornecedor["bairro"] : ""; ?>" required
                oninput="this.value = this.value.toUpperCase()" />
    ...
    <div class="col-sm-2">
        ...
        <div class="form-outline">
            ...
            <input type="text" name="cidade" id="cidade" class="form-control text-uppercase" placeholder=""
                value="<?= isset($fornecedor) ? $fornecedor["cidade"] : ""; ?>" required
                oninput="this.value = this.value.toUpperCase()" />
        </div>
    </div>
    <div class="col-sm-1">
        ...
        <div class="form-outline">
            ...
            <input type="text" name="estado" id="uf" class="form-control text-uppercase"
                value="<?= isset($fornecedor) ? $fornecedor["estado"] : ""; ?>" required
                oninput="this.value = this.value.toUpperCase()" />
        </div>
    </div>
</div>
