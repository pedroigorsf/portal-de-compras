                    ...
                    <?php if (isset($fornecedor)): ?>
                        <div class="col-sm-2">
                            ...
                            <input type="radio" value="1" class="btn-check btn w-100" name="stats" id="success-outlined"
                                autocomplete="off" <?= $fornecedor['stats'] == 1 ? 'checked' : ""; ?>>
                            ...
                            <input type="radio" value="0" class="btn-check btn w-100" name="stats" id="danger-outlined"
                                autocomplete="off" <?= $fornecedor['stats'] == 0 ? 'checked' : ""; ?>>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-outline">
                                ...
                                <input type="text" name="endereco" id="rua" class="form-control text-uppercase"
                                    placeholder="" value="<?= isset($fornecedor) ? $fornecedor["endereco"] : ""; ?>"
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-outline">
                                ...
                                <input type="text" name="bairro" id="bairro" class="form-control text-uppercase"
                                    placeholder="" value="<?= isset($fornecedor) ? $fornecedor["bairro"] : ""; ?>"
                                    required oninput="this.value = this.value.toUpperCase()" />
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-outline">
                                ...
                                <input type="text" name="cidade" id="cidade" class="form-control text-uppercase"
                                    placeholder="" value="<?= isset($fornecedor) ? $fornecedor["cidade"] : ""; ?>"
                                    required oninput="this.value = this.value.toUpperCase()" />
                            </div>
                        </div>
                        <div class="col-sm-1">
